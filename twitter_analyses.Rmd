...
amia_tweets_discussion_summary_1<-amia_tweets_discussion_summary %>% filter(year==2013,user_mention_count==1)
amia_tweets_discussion_summary<-amia_tweets_discussion_summary[-15,]
amia_tweets_discussion<-amia_tweets_discussion %>% mutate(label=ifelse(year==2011,"2011\nTotal Original Tweets = 1020",ifelse(year==2012,"2012\nTotal Original Tweets = 3060","2013\nTotal Original Tweets = 3671")))
